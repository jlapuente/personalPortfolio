  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      ...
      .then(
        () => {
          setLoading(false);
          alert("Gracias por tu interes. Te contactaré tan pronto como me sea posible.");
        ...
        (error) => {
          ...
          alert("Ahh, algo ha ido mal. Intentalo de nuevo.");
        }
      );
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className={styles.sectionSubText}>Mantengamos el contacto</p>
        ...
        >
          ...
          <label className='flex flex-col'>
            <span className='text-white font-medium mb-4'>¿Que quieres decirme?</span>
            <textarea
              rows={7}
              name='message'
              value={form.message}
              onChange={handleChange}
              placeholder='¿Por qué me contactas?'
              className='bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium'
            />
          </label>
